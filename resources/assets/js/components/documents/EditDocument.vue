					...
					<div class="main-content">
						<div class="content-card">
							<div class="note-content">
								<h1 style="text-align: center;">Chỉnh sửa tài liệu</h1>
								<br>
    ...
    export default {
        ...
        methods: {
            editDocumentation() {
                ...
                this.$store.dispatch('documentation/fetchUpdateDocumentation', payload)
                .then(response => {
            ...
            fetchDetailDocumentation(id) {
                ...
                .then(response => {
                    if (response.data.hasOwnProperty('errors')) {
                        this.message['errors'] = 'Không thể tải tài liệu. Vui lòng thử lại sau';
                    }
                    else {
                        this.subject = response.data.data.subject.id
